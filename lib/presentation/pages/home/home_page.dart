  ...
  Widget _buildSuggestions() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        _suggestionItem('🥣', 'Lasopy sy anana', 'Soupe malgache',
            '8 500 Ar', '6 pers.'),
        _suggestionItem(
            '🍲', 'Romazava', 'Viande + Légumes', '10 000 Ar', '5 pers.'),
        _suggestionItem(
            '🫘', 'Ravitoto', 'Manioc + Haricots', '6 500 Ar', '4 pers.'),
      ],
    );
  }
